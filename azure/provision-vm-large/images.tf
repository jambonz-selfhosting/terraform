...
locals {
  ...
  web_image_id            = "/communityGalleries/${var.community_gallery_name}/images/jambonz-web${local.image_arch_suffix}/versions/${var.jambonz_version}"
  monitoring_image_id     = "/communityGalleries/${var.community_gallery_name}/images/jambonz-monitoring${local.image_arch_suffix}/versions/${var.jambonz_version}"
