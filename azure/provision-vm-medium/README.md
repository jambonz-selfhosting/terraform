...
4. **Packer Images**: Build 4 jambonz images using Packer:
   - SBC image
   - Feature Server image
   - Web/Monitoring image
   - Recording Server image (optional)
...
2. **Edit `terraform.tfvars`** with your values:
   ...
   - Image names and resource group
   - URL portal domain
   - SSH public key
...
| `image_resource_group` | Resource group containing Packer images |
| `sbc_image_name` | Name of SBC image |
| `feature_server_image_name` | Name of Feature Server image |
| `web_monitoring_image_name` | Name of Web/Monitoring image |
