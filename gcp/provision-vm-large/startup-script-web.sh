#!/bin/bash -xe
# Startup script for jambonz Web server on GCP (Large deployment)
...
echo "Starting jambonz Web server configuration for GCP large deployment"
...
# Configure nginx (web-only: portal, API, public-apps)
